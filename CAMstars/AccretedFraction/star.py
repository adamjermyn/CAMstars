...
import opacity
from constants import kB, mP, rSun, mSun, tSun, yr, newtonG, fSun, lSun, sigma

opalName = 'Opacity Tables/Opal/GS98.txt'
fergName = 'Opacity Tables/Ferguson/f05.gs98/'
op = opacity.opac(opalName, fergName, 0.7, 0.28)
